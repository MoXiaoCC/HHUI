...
function themeConfig($form) {
    ...
    $beian = new Typecho_Widget_Helper_Form_Element_Text('beian', NULL, NULL, _t('网站备案号'), _t(''));
    $form->addInput($beian);
...
{ 
    // 当文章无图片时的默认缩略图
    $dir = './usr/themes/HHUI/img/sj/';//随机缩略图目录
...
foreach ($widget->tags as $tag) {
    ...
    $ctu = './usr/themes/HHUI/img/tag/' . $tag['slug'] . '.jpg';
